<?php 
// Adds widget: Homepage Feature
class Homepagefeature_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'homepagefeature_widget',
			esc_html__( 'Homepage Highlight', 'textdomain' ),
			array( 'description' => esc_html__( 'Content featured on the homepage.', 'textdomain' ), ) // Args
		);
	...
	private $widget_fields = array(
		array(
			'label' => 'Heading',
			'id' => 'heading',
			'default' => 'Hudson Valley Highlights',
			'type' => 'text',
		),
		array(
			'label' => 'Subheading',
			'id' => 'subheading',
			'default' => 'Featured Pollinator',
			'type' => 'text',
		),
		array(
			'label' => 'Summary',
	...
	public function widget( $args, $instance ) {
		...
		echo '<article class="homepage-highlight">';
			echo '<div class="image">';
				echo '<a href="'.$url.'" title="'.$subheading.'">';
					echo '<img src="'.$image.'" alt="'.$subheading.'" />';
				echo '</a>';
			echo '</div>';
			echo '<div class="content">';
				...
				echo '<div class="readmore"><a href="'.$url.'" title="Read More">Read More...</a></div>';
			echo '</div>';
		echo '</article>';
...
function register_homepagefeature_widget() {
	register_widget( 'Homepagefeature_Widget' );
}
add_action( 'widgets_init', 'register_homepagefeature_widget' );