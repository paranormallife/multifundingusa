<?php
// Adds widget: Widget
class homepage_hero extends WP_Widget {

	function __construct() {
		parent::__construct(
			'homepage_hero',
			esc_html__( 'Homepage Hero', 'textdomain' ),
			array( 'description' => esc_html__( 'Large hero banner on homepage.', 'textdomain' ), ) // Args
		);
	...
	public function widget( $args, $instance ) {
        ...
        echo '<a href="'.$url.'" class="homepage-hero-image" style="background-image: url(\''.$image.'\')">';
            echo '<img src="'.$image.'" alt="'.$subtitle.'" />';
...
function register_homepage_hero() {
	register_widget( 'homepage_hero' );
}
add_action( 'widgets_init', 'register_homepage_hero' );