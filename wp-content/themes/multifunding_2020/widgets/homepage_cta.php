...
// Adds widget: Homepage CTA
class Homepagecta_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'homepagecta_widget',
			esc_html__( 'Homepage CTA', 'textdomain' ),
			array( 'description' => esc_html__( 'Calls-to-Action on the homepage.', 'textdomain' ), ) // Args
		);
...
function register_homepagecta_widget() {
	register_widget( 'Homepagecta_Widget' );
}
add_action( 'widgets_init', 'register_homepagecta_widget' );